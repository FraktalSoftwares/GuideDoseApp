...
import 'p_calc_model.dart';
export 'p_calc_model.dart';

class PCalcWidget extends StatefulWidget {
  const PCalcWidget({super.key});

  @override
  State<PCalcWidget> createState() => _PCalcWidgetState();
}

class _PCalcWidgetState extends State<PCalcWidget> {
  late PCalcModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PCalcModel());

    _model.inputKGTextController ??=
        TextEditingController(text: FFAppState().User.uSRKGs);
    _model.inputKGFocusNode ??= FocusNode();

    _model.inputKGMask = MaskTextInputFormatter(mask: '###');
    _model.inputAlturaTextController1 ??=
        TextEditingController(text: FFAppState().User.usrAltura);
    _model.inputAlturaFocusNode1 ??= FocusNode();

    _model.inputAlturaMask1 = MaskTextInputFormatter(mask: '###');
    _model.inputAlturaTextController2 ??=
        TextEditingController(text: FFAppState().User.usrIdade);
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Container(
                            width: double.infinity,
                            child: TextFormField(
                              controller: _model.inputKGTextController,
                              focusNode: _model.inputKGFocusNode,
                              autofocus: false,
                              ...
                              validator: _model.inputKGTextControllerValidator
                                  .asValidator(context),
                              inputFormatters: [_model.inputKGMask],
                            ),
                          ),
                        ),
                        Padding(
                          ...
                          child: Container(
                            width: double.infinity,
                            child: TextFormField(
                              controller: _model.inputAlturaTextController1,
                              focusNode: _model.inputAlturaFocusNode1,
                              autofocus: false,
                              textInputAction: TextInputAction.next,
                              obscureText: false,
                              decoration: InputDecoration(
                              ...
                              enableInteractiveSelection: true,
                              validator: _model
                                  .inputAlturaTextController1Validator
                                  .asValidator(context),
                              inputFormatters: [_model.inputAlturaMask1],
                            ),
                          ),
                        ),
                        Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                Expanded(
                                  child: Container(
                                    ...
                                    child: TextFormField(
                                      controller:
                                          _model.inputAlturaTextController2,
                                      focusNode: _model.inputAlturaFocusNode2,
                                      autofocus: false,
                                      textCapitalization:
                                      ...
                                      enableInteractiveSelection: true,
                                      validator: _model
                                          .inputAlturaTextController2Validator
                                          .asValidator(context),
                                      inputFormatters: [
                                        _model.inputAlturaMask2
                                      ],
                                    ),
                                  ),
                                ),
                                ...
                                FlutterFlowDropDown<String>(
                                  controller:
                                      _model.dropDownAnosValueController ??=
                                          FormFieldController<String>(
                                    _model.dropDownAnosValue ??=
                                        FFAppState().User.usrAnosmeses,
                                  ),
                                  options: List<String>.from(
                                      FFAppConstants.anosMeses),
                                  optionLabels: [
                                    FFLocalizations.of(context).getText(
                                      'vhzirs1o' /* Anos */,
                                    ),
                            ...
                            child: Row(
                              ...
                              children: [
                                InkWell(
                                  ...
                                  highlightColor: Colors.transparent,
                                  onTap: () async {
                                    FFAppState().generoSelecionado = 'Feminino';
                                    FFAppState().update(() {});
                                  },
                                  child: Container(
                                    decoration: BoxDecoration(
                                          ...
                                          child: Image.network(
                                            valueOrDefault<String>(
                                              FFAppState().generoSelecionado ==
                                                      'Feminino'
                                                  ? 'https://storage.googleapis.com/flutterflow-io-6f20.appspot.com/projects/m-c-guide-dose-0vlmcq/assets/5sfju0c3eep0/Radio_(1).png'
                                                  : 'https://storage.googleapis.com/flutterflow-io-6f20.appspot.com/projects/m-c-guide-dose-0vlmcq/assets/2zv4fq6byxz5/Radio.png',
                                              'https://storage.googleapis.com/flutterflow-io-6f20.appspot.com/projects/m-c-guide-dose-0vlmcq/assets/2zv4fq6byxz5/Radio.png',
                                            ),
                                            width: 40.0,
                                            height: 40.0,
                            ...
                            onPressed: () async {
                              ...
                              FFAppState().updateUserStruct(
                                (e) => e
                                  ..usrIdade =
                                      _model.inputAlturaTextController2.text
                                  ..uSRKGs = _model.inputKGTextController.text
                                  ..usrAltura =
                                      _model.inputAlturaTextController1.text
                                  ..usrGenero = FFAppState().generoSelecionado
                              ...
                              safeSetState(() {
                                ...
                                _model.inputKGMask.updateMask(
                                  newValue: TextEditingValue(
                                      text: FFAppState().User.uSRKGs),
                                );
                                _model.inputAlturaTextController1?.text =
                                    FFAppState().User.usrAltura;

                                _model.inputAlturaMask1.updateMask(
                                  newValue: TextEditingValue(
                                      text: FFAppState().User.usrAltura),
                                );
                                _model.inputAlturaTextController2?.text =
                                    FFAppState().User.usrIdade;

                                _model.inputAlturaMask2.updateMask(
                                  newValue: TextEditingValue(
                                      text: FFAppState().User.usrIdade),
                                );
                              });
                              Navigator.pop(context);
