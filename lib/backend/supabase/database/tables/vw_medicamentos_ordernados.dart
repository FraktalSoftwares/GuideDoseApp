...
class VwMedicamentosOrdernadosTable
    extends SupabaseTable<VwMedicamentosOrdernadosRow> {
  @override
  String get tableName => 'vw_medicamentos_ordernados';

  @override
  VwMedicamentosOrdernadosRow createRow(Map<String, dynamic> data) =>
      VwMedicamentosOrdernadosRow(data);
}

class VwMedicamentosOrdernadosRow extends SupabaseDataRow {
  VwMedicamentosOrdernadosRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => VwMedicamentosOrdernadosTable();
