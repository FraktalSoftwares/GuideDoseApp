...
class InducoesTable extends SupabaseTable<InducoesRow> {
  @override
  String get tableName => 'inducoes';

  @override
  InducoesRow createRow(Map<String, dynamic> data) => InducoesRow(data);
}

class InducoesRow extends SupabaseDataRow {
  InducoesRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => InducoesTable();
